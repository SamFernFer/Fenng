...
void init() {
    ...
    // Creates the window.
    mainWindow = Window::create(800, 600, "Matrix", nullptr, nullptr);
    ...
    vertShader = Stage::buildFromFile(Stage::Vertex, getResPath("shaders/Matrix.vert"));
    fragShader = Stage::buildFromFile(Stage::Fragment, getResPath("shaders/Matrix.frag"));

#ifndef FENNTON_UTILS_MISC_HPP
#define FENNTON_UTILS_MISC_HPP
...
namespace Fennton {
...
#ifndef FENNTON_UTILS_DISABLE_STDOUT_PRINT
    // Prints the value.
    ...
    template<typename...A> static void printf(std::string_view str, A&&... args) {
        print(std::vformat(str, std::make_format_args(args...)));
    }
    // Prints a new-line.
    void println();
    // Prints the value, followed by a new-line.
    template<typename T> void println(const T& v) {
        (*Fennton::out) << v << std::endl;
    }
    ...
    template<typename...A> static void printf(std::ostream& stream, std::string_view str, A&&... args) {
        print(stream, std::vformat(str, std::make_format_args(args...)));
    }
    ...
    template<typename...A> static void printlnf(std::ostream& stream, std::string_view str, A&&... args) {
        println(stream, std::vformat(str, std::make_format_args(args...)));
    }
